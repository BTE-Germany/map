    ...
    return (
        <div>
            ...
            <Menu trigger="hover" delay={500} control={<ActionIcon variant="outline"><AiOutlineUser/></ActionIcon>}>
                ...
                {
                    keycloak?.authenticated && <Menu.Item icon={<AiOutlineUser size={14}/>} disabled>Hey, {keycloak?.tokenParsed.preferred_username}</Menu.Item>
                }
                {
                ...
                {
                    keycloak?.authenticated && <Menu.Item icon={<FiLink2 size={14}/>} component={Link} to={"/link"}>Link Minecraft Account</Menu.Item>
                }
