                ...
                <form onSubmit={codeForm.onSubmit((values) => linkAccount(values))}>
                    <Stepper active={active} onStepClick={setActive} breakpoint="sm" mt={"xl"} >
                        <Stepper.Step label="First step" description="Connect to the server" py={"md"}>
                            First connect to our server. To to that, open Minecraft and click on "Multiplayer". Then click
                        ...
                        <Stepper.Step label="Second step" description="Get your link code" py={"md"}>
                            Now press <Kbd>T</Kbd> to open your chat. Here, enter <Code>/link</Code> and press enter. You
                    ...
                    <Group position="center" mt="xl">
                        ...
                        {
                            active !== 0 && <Button variant="default" onClick={prevStep} disabled={loading}>Back</Button>
                        }
                        {
                            active === 2 ? <Button type="submit" loading={loading}>Link Account</Button> : <Button onClick={nextStep}>Next step</Button>
                        }
